...
<body class="home">
    ...
    <header id="head">
        <div class="container">
            <div class="row">
                <h1 class="lead">Welcome to Fahad's World.!!!</h1>
                <p class="tagline"><b>Always Dedicated to your </b><a href="http://www.gettemplate.com/?utm_source=progressus&amp;utm_medium=template&amp;utm_campaign=progressus"><b>Service</b></a></p>
            </div>
        </div>
    </header>
    <!-- /Header -->
    ...
    <div class="container text-center">
        ...
        <p class="text-muted">
            The difference between involvement and commitment is like an eggs-and-beef breakfast:<br>
            the chicken was involved; the beef was committed.
        </p>
    </div>
    <!-- /Intro-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 widget">
                        ...
                        <div class="widget-body">
                            <p>+088 23 9873237<br>
                                <a href="mailto:#">f20_777@yahoo.com</a><br>
                                <br>
                                BCC Bhaban, Agargaon, Dhaka, Bangladesh.
                            </p>
                        </div>
                    </div>
